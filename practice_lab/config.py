...
PUBLIC_AUDIO_DIR = Path(os.environ.get("PRACTICE_LAB_PUBLIC_AUDIO_DIR", PUBLIC_DIR / "audio")).resolve()
PUBLIC_VIDEO_DIR = Path(os.environ.get("PRACTICE_LAB_PUBLIC_VIDEO_DIR", PUBLIC_DIR / "video")).resolve()
PUBLIC_SCORE_DIR = Path(os.environ.get("PRACTICE_LAB_PUBLIC_SCORE_DIR", PUBLIC_DIR / "score")).resolve()
PUBLIC_STEMS_DIR = Path(os.environ.get("PRACTICE_LAB_PUBLIC_STEMS_DIR", PUBLIC_DIR / "stems")).resolve()
